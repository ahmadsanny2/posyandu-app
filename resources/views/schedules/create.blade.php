        ...
        <x-card title="Formulir Jadwal Kegiatan" subtitle="Masukkan rincian kegiatan posyandu mendatang">
            <form method="POST" action="{{ route('schedules.store') }}" class="space-y-6">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="description" name="description" rows="4" class="mt-1 block w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring focus:ring-blue-100 transition-shadow" placeholder="Contoh: Pemeriksaan tumbuh kembang balita rutin, pembagian Makanan Tambahan (PMT) biskuit, serta imunisasi Campak. Harap membawa buku KIA.">{{ old('description') }}</textarea>
