<x-app-layout>
    ...
    <div class="max-w-2xl">
        ...
        <x-card title="Ubah Rincian Jadwal" subtitle="Sesuaikan detail pelaksanaan kegiatan">
            <form method="POST" action="{{ route('schedules.update', $schedule->id) }}" class="space-y-4">
                @csrf
                @method('PATCH')
