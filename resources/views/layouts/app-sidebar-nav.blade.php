...
@if(auth()->user()->isAdmin())
    ...
    <!-- Kelola Kader -->
    <a href="{{ route('kaders.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors {{ request()->routeIs('kaders.*') ? 'bg-blue-50 text-primary font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800' }}">
    ...
    <!-- Konfigurasi Sistem -->
    <a href="{{ route('settings.edit') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors {{ request()->routeIs('settings.*') ? 'bg-blue-50 text-primary font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-800' }}">
