<x-dynamic-component :component="auth()->user()->isParent() ? 'parent-layout' : 'app-layout'">
    ...
    <div class="space-y-6">
        ...
        <x-card title="Ubah Data Balita" subtitle="Sesuaikan rincian informasi balita: {{ $toddler->name }}">
            <form method="POST" action="{{ route('toddlers.update', $toddler->id) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="birth_date" name="birth_date" type="date" class="mt-1 block w-full" :value="old('birth_date', $toddler->birth_date->format('Y-m-d'))" required />
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="address" name="address" type="text" class="mt-1 block w-full" :value="old('address', $toddler->address)" />
                        ...
                        <div>
                            ...
                            <textarea id="medical_history" name="medical_history" rows="6" class="mt-1 block w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring focus:ring-blue-100 transition-shadow">{{ old('medical_history', $toddler->medical_history) }}</textarea>
