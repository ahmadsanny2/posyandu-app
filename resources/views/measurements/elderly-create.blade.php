<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <x-card title="Input Pemeriksaan Lansia" subtitle="Masukkan data pemeriksaan kesehatan lansia untuk: {{ $elderly->name }} pada kegiatan {{ $schedule->title }}">
            <form method="POST" action="{{ route('elderlies.record.store') }}" class="space-y-4">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <!-- Blood Sugar -->
                    <div>
                        <x-input-label for="blood_sugar" value="Gula Darah (mg/dL)" />
                    ...
                    <!-- Cholesterol -->
                    <div>
                        <x-input-label for="cholesterol" value="Kolesterol (mg/dL)" />
                    ...
                    <!-- Uric Acid -->
                    <div>
                        <x-input-label for="uric_acid" value="Asam Urat (mg/dL)" />
