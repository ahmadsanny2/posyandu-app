<x-dynamic-component :component="auth()->user()->isParent() ? 'parent-layout' : 'app-layout'">
    ...
    <div class="space-y-6 max-w-5xl">
        <div class="mb-4">
            <a href="{{ auth()->user()->isParent() ? route('dashboard') : route('pregnant-women.index') }}" class="text-sm font-semibold text-slate-500 hover:text-slate-800 flex items-center gap-1.5">&larr; Kembali</a>
        </div>
