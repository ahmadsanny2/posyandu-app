<x-dynamic-component :component="auth()->user()->isParent() ? 'parent-layout' : 'app-layout'">
    ...
    <div class="space-y-6">
        ...
        <x-card title="Ubah Data Ibu Hamil" subtitle="Sesuaikan rincian informasi kehamilan: {{ $pregnantWoman->name }}">
            <form method="POST" action="{{ route('pregnant-women.update', $pregnantWoman->id) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="estimated_delivery_date" name="estimated_delivery_date" type="date" class="mt-1 block w-full" :value="old('estimated_delivery_date', $pregnantWoman->estimated_delivery_date->format('Y-m-d'))" required />
                        ...
                        @if(!auth()->user()->isParent())
                            <div>
                                <x-input-label for="user_id" value="Orang Tua/Suami" />
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="address" name="address" type="text" class="mt-1 block w-full" :value="old('address', $pregnantWoman->address)" />
                        ...
                        <div>
                            ...
                            <textarea id="medical_history" name="medical_history" rows="6" class="mt-1 block w-full rounded-xl border-slate-200 text-sm focus:border-primary focus:ring focus:ring-blue-100 transition-shadow">{{ old('medical_history', $pregnantWoman->medical_history) }}</textarea>
